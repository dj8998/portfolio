...
export default function ContactSection() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("dineshmjangid01@gmail.com");
    setCopied(true);
  ...
  return (
    <section id="contact" className="relative z-10 flex flex-col items-center justify-center w-full py-16 bg-transparent max-w-[90vw] mx-auto px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center">
        <button
          onClick={copyEmail}
          className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold transition-colors duration-200 flex items-center gap-2"
        >
        ...
        <div className="flex gap-4">
          <a 
            href="https://www.linkedin.com/in/dj8998/" 
            target="_blank" 
